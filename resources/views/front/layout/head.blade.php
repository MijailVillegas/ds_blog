    ...
    <title>Diagnosis Estudios</title>
    <link href="{{asset('front/css/media_query.css')}}" rel="stylesheet" type="text/css"/>
    ...
    <!-- Bootstrap CSS -->
    <link href="{{asset('front/css/style_1.css')}}" rel="stylesheet" type="text/css"/>